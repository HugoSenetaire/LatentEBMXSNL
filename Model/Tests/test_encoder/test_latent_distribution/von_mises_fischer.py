...
def test_kl_von_mises_fischer():
    cfg = get_config(config_name="conf_hyperspherical")
    ...
    entropy_empirical = uniform_posterior.calculate_entropy(param, dic_params=dic_params, empirical_entropy=True, n_samples=100000)
